...
const Banner = () => {
  ...
  // Simple fade animation instead of letter-by-letter
  const textVariants = {
    hidden: { 
      opacity: 0,
      y: 20
  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        <div className="relative w-full bg-gray-950 overflow-hidden" style={{ height: '60vh', minHeight: '400px' }}>
        ...
        {/* Text Content with Fixed Height to Prevent Layout Shift */}
        <div className="relative bg-transparent px-6 py-6">
          <div className="max-w-4xl mx-auto space-y-4">
            {/* Simple Fade Animation - No Letter Split */}
