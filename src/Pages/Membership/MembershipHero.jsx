...
const MembershipHero = () => {
  const sentence =
    "“Unlock exclusive decor experiences, early bookings, and a lifestyle of premium privileges with Soni Blissful Events.”";
    ...
    <section className="relative h-[60vh] md:h-[70vh] lg:h-[90vh] w-full overflow-hidden">
      ...
      >
        <img
          ...
          alt="Soni Blissful Events Membership"
      ...
      <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 font-serif tracking-tight text-white drop-shadow-xl">
           खास लोगों में शामिल हों। 
            <br />
            हर पल खास महसूस करें।
          </h1>
