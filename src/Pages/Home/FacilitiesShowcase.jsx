const SignatureFacilities = () => {
  const facilities = [
    {
      name: "Grand Event Hotels Raipur", 
      image: "/SignatureImg/Grand-event-img.webp",

      specs: [
        "Spacious Event Hall / Main Stage",
        "Advanced Audio-Visual Setup",
        "Exclusive VIP Seating & Viewing Area",
      ],
    },
    {
      name:"Grand Stage & Event Hall",
      image: "/SignatureImg/Grand-event-img2.webp",
      specs: [
        , 
        "Premium Decor Setup", 
        "Main Stage & Decor Highlights",
        "Centerpiece Event Styling"
      ],
    },
  ];
