      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-serif">
            Raipur<span className="text-yellow-500"> Navratri Garba Night </span> Pass
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            To collect your exclusive Garba Night Pass, <span className="font-mono font-bold text-yellow-600">GARBANIGHT</span>
          </p>
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-black mb-3">
           Garba Pass Limited Time Offer!
          </h3>
          <p className="text-lg text-gray-900 mb-6">
            Get <span className="font-bold">50% OFF</span> your pass — today and save big!
          </p>
          <Link
